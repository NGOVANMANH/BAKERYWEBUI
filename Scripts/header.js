...
<img
            ...
            <ul class="menu">
                ...
                <li class="menu__sub-menu">
                    <a href="" class="menu__sub-menu--link"
                        >HỆ THỐNG CỬA HÀNG</a
                    >
                </li>
                <li class="menu__sub-menu">
                    <a href="" class="menu__sub-menu--link">GIỚI THIỆU</a>
                </li>
                <li class="menu__sub-menu">
                    <a href="" class="menu__sub-menu--link">TUYỂN DỤNG</a>
                </li>
                <li class="menu__sub-menu">
                    <a href="" class="menu__sub-menu--link">LIÊN HỆ</a>
                </li>
            </ul>
            <div class="option">
